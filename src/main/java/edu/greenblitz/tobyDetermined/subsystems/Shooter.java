...
public class Shooter extends GBSubsystem {
	...
	private Shooter() {
		this.motor = new GBSparkMax(RobotMap.Shooter.ShooterMotor.PORT_LEADER, CANSparkMaxLowLevel.MotorType.kBrushless);
		motor.config(RobotMap.Shooter.ShooterMotor.shooterConf);
...
//		System.out.println(target);
		motor.getPIDController().setReference(target * flipped, CANSparkMax.ControlType.kVelocity, 0, RobotMap.Shooter.ShooterMotor.feedforward.calculate(target), SparkMaxPIDController.ArbFFUnits.kVoltage);
		//
	}
