...
public class OI { //GEVALD
	...
	public void butt(){
		...
		mainJoystick.A.whileTrue(new NodeFullPathCommand(NodeBase.getNode(NodeBase.SpecificNode.REST_ABOVE_BELLY)));
		mainJoystick.X.whileTrue(new NodeFullPathCommand(NodeBase.getNode(NodeBase.SpecificNode.ZIG_HAIL)));
		mainJoystick.Y.whileTrue(new NodeFullPathCommand(NodeBase.getNode(NodeBase.SpecificNode.CONE_HIGH)));
		mainJoystick.B.whileTrue(new NodeFullPathCommand(NodeBase.getNode(NodeBase.SpecificNode.LOW)));
