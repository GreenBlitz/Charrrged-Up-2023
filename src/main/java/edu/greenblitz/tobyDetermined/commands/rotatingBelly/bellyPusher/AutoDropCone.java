...
public class AutoDropCone extends SequentialCommandGroup {
    public AutoDropCone(){
        addCommands(
                new ParallelCommandGroup(new GoToPosition(RobotMap.TelescopicArm.PresetPositions.PRE_INTAKE_GRAB_POSITION), new InstantCommand(()-> Claw.getInstance().coneCatchMode())),
