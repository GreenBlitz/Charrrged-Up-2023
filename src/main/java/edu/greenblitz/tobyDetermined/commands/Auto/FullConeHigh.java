...
import edu.greenblitz.tobyDetermined.commands.telescopicArm.goToPosition.PassWallAndExtend;
...
public class FullConeHigh extends SequentialCommandGroup {
	...
	public FullConeHigh(){
		super(
				new GoToPosition(RobotMap.TelescopicArm.PresetPositions.CONE_HIGH).raceWith(new WaitCommand(5)).alongWith(new GripCone().raceWith(new WaitCommand(1))),
